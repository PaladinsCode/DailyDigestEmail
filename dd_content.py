...
import json
import datetime
from credentials_setup import OPEN_WEATHER_API_KEY, TWITTER_API_KEY, TWITTER_API_SECRET_KEY
import tweepy
...
):  # default location at Cape Canaveral, FL
    try:  # retrieve forecast for specified coordinates
        api_key = OPEN_WEATHER_API_KEY  # OpenWeatherMap API key
        ...
        forecast = {
            ...
            "periods": [],
        }  # list to hold forecast data for future periods
...
def get_twitter_trends(woeid=23424977): # default WOEID for United States
    try: # retrieve Twitter trends for specified location
        api_key = TWITTER_API_KEY # replace with your own Twitter API key
        api_secret_key = TWITTER_API_SECRET_KEY # replace with your own Twitter API secret key
